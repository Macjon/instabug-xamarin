...
namespace Com.Instabug.Survey.Utils {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.instabug.survey.utils']/class[@name='SurveysUtils']"
	[global::Android.Runtime.Register ("com/instabug/survey/utils/SurveysUtils", DoNotGenerateAcw=true)]
	public partial class SurveysUtils : global::Java.Lang.Object {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/instabug/survey/utils/SurveysUtils", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.instabug.survey.utils']/class[@name='SurveysUtils']/constructor[@name='SurveysUtils' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		...
		public static unsafe bool IsSurveysFeatureAvailable {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.survey.utils']/class[@name='SurveysUtils']/method[@name='isSurveysFeatureAvailable' and count(parameter)=0]"
		...
		public static unsafe bool IsSurveysFeatureEnabled {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.survey.utils']/class[@name='SurveysUtils']/method[@name='isSurveysFeatureEnabled' and count(parameter)=0]"
