...
namespace Org.Jcodec.Containers.Mkv.Demuxer {
	...
	public sealed partial class MKVDemuxer : global::Java.Lang.Object {
		...
		public partial class AudioTrack : global::Java.Lang.Object {
			...
			public unsafe AudioTrack (global::Org.Jcodec.Containers.Mkv.Demuxer.MKVDemuxer __self, int trackNo)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					__args [1] = new JValue (trackNo);
					if (((object) this).GetType () != typeof (AudioTrack)) {
						SetHandle (
...
#pragma warning disable 0169
			...
			static IntPtr n_GetFrames_I (IntPtr jnienv, IntPtr native__this, int count)
			{
				global::Org.Jcodec.Containers.Mkv.Demuxer.MKVDemuxer.AudioTrack __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Containers.Mkv.Demuxer.MKVDemuxer.AudioTrack> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				return JNIEnv.ToLocalJniHandle (__this.GetFrames (count));
			}
#pragma warning restore 0169
			...
			public virtual unsafe global::Org.Jcodec.Common.Model.Packet GetFrames (int count)
			{
...
#pragma warning disable 0169
			...
			static bool n_GotoFrame_J (IntPtr jnienv, IntPtr native__this, long i)
			{
				global::Org.Jcodec.Containers.Mkv.Demuxer.MKVDemuxer.AudioTrack __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Containers.Mkv.Demuxer.MKVDemuxer.AudioTrack> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				return __this.GotoFrame (i);
			}
#pragma warning restore 0169
			...
			public virtual unsafe bool GotoFrame (long i)
			{
...
#pragma warning disable 0169
			...
			static bool n_GotoSyncFrame_J (IntPtr jnienv, IntPtr native__this, long frame)
			{
				global::Org.Jcodec.Containers.Mkv.Demuxer.MKVDemuxer.AudioTrack __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Containers.Mkv.Demuxer.MKVDemuxer.AudioTrack> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				return __this.GotoSyncFrame (frame);
			}
#pragma warning restore 0169
			...
			public virtual unsafe bool GotoSyncFrame (long frame)
			{
...
#pragma warning restore 0169
		...
		public partial class IndexedBlock : global::Java.Lang.Object {
				...
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					if (((object) this).GetType () != typeof (IndexedBlock)) {
						SetHandle (
			...
			public static unsafe global::Org.Jcodec.Containers.Mkv.Demuxer.MKVDemuxer.IndexedBlock Make (int no, global::Org.Jcodec.Containers.Mkv.Boxes.MkvBlock b)
			{
		...
		public partial class VideoTrack : global::Java.Lang.Object {
			...
			public unsafe VideoTrack (global::Org.Jcodec.Containers.Mkv.Demuxer.MKVDemuxer __self, int trackNo, global::Java.Nio.ByteBuffer state)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
					return;
				...
				try {
					...
					__args [0] = new JValue (__self);
					__args [1] = new JValue (trackNo);
					__args [2] = new JValue (state);
					if (((object) this).GetType () != typeof (VideoTrack)) {
						SetHandle (
								global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(L" + global::Android.Runtime.JNIEnv.GetJniName (GetType ().DeclaringType) + ";ILjava/nio/ByteBuffer;)V", __args),
								JniHandleOwnership.TransferLocalRef);
...
#pragma warning disable 0169
			...
			static bool n_GotoSyncFrame_J (IntPtr jnienv, IntPtr native__this, long i)
			{
				global::Org.Jcodec.Containers.Mkv.Demuxer.MKVDemuxer.VideoTrack __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Containers.Mkv.Demuxer.MKVDemuxer.VideoTrack> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				return __this.GotoSyncFrame (i);
			}
#pragma warning restore 0169
			...
			[Register ("gotoSyncFrame", "(J)Z", "GetGotoSyncFrame_JHandler")]
			public virtual unsafe bool GotoSyncFrame (long i)
			{
				if (id_gotoSyncFrame_J == IntPtr.Zero)
					id_gotoSyncFrame_J = JNIEnv.GetMethodID (class_ref, "gotoSyncFrame", "(J)Z");
				try {
