...
namespace Org.Jcodec.Common.Model {
	...
	public partial class AudioFrame : global::Org.Jcodec.Common.Model.AudioBuffer {
		...
		public unsafe AudioFrame (global::Org.Jcodec.Common.Model.AudioBuffer other, long pts, long duration, long timescale, int frameNo)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (AudioFrame)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Lorg/jcodec/common/model/AudioBuffer;JJJI)V", __args),
