...
namespace Org.Jcodec.Codecs.H264.IO.Write {
	...
	public partial class NALUnitWriter : global::Java.Lang.Object {
		...
		public unsafe NALUnitWriter (global::Java.Nio.Channels.IWritableByteChannel to)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [0] = new JValue (to);
				if (((object) this).GetType () != typeof (NALUnitWriter)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Ljava/nio/channels/WritableByteChannel;)V", __args),
