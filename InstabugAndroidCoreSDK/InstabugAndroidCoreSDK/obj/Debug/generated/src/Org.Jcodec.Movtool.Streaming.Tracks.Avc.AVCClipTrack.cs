...
#pragma warning restore 0169
		...
		public partial class TranscodePacket : global::Org.Jcodec.Movtool.Streaming.Tracks.VirtualPacketWrapper {
			...
			internal static new IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("org/jcodec/movtool/streaming/tracks/avc/AVCClipTrack$TranscodePacket", ref java_class_handle);
				}
			}
			...
			protected override global::System.Type ThresholdType {
				get { return typeof (TranscodePacket); }
			}
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/jcodec/movtool/streaming/tracks/avc/AVCClipTrack", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (AVCClipTrack); }
		}
