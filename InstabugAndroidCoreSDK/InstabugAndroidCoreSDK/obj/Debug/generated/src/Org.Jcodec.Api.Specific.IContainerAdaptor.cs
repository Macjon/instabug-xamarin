...
namespace Org.Jcodec.Api.Specific {
	...
	public partial interface IContainerAdaptor : IJavaObject {
		...
		global::Org.Jcodec.Api.FrameGrab.MediaInfo MediaInfo {
			...
			[Register ("getMediaInfo", "()Lorg/jcodec/api/FrameGrab$MediaInfo;", "GetGetMediaInfoHandler:Org.Jcodec.Api.Specific.IContainerAdaptorInvoker, InstabugAndroidCoreSDK")] get;
		}
		...
		[Register ("allocatePicture", "()[[I", "GetAllocatePictureHandler:Org.Jcodec.Api.Specific.IContainerAdaptorInvoker, InstabugAndroidCoreSDK")]
		int[][] AllocatePicture ();
		...
		[Register ("canSeek", "(Lorg/jcodec/common/model/Packet;)Z", "GetCanSeek_Lorg_jcodec_common_model_Packet_Handler:Org.Jcodec.Api.Specific.IContainerAdaptorInvoker, InstabugAndroidCoreSDK")]
		...
		[Register ("decodeFrame", "(Lorg/jcodec/common/model/Packet;[[I)Lorg/jcodec/common/model/Picture;", "GetDecodeFrame_Lorg_jcodec_common_model_Packet_arrayarrayIHandler:Org.Jcodec.Api.Specific.IContainerAdaptorInvoker, InstabugAndroidCoreSDK")]
