...
namespace Org.Jcodec.Containers.Mkv.Boxes {
	...
	public abstract partial class EbmlBase : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (EbmlBase)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		static bool n_EqualId_arrayB (IntPtr jnienv, IntPtr native__this, IntPtr native_typeId)
		{
			global::Org.Jcodec.Containers.Mkv.Boxes.EbmlBase __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Containers.Mkv.Boxes.EbmlBase> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			byte[] typeId = (byte[]) JNIEnv.GetArray (native_typeId, JniHandleOwnership.DoNotTransfer, typeof (byte));
			bool __ret = __this.EqualId (typeId);
			if (typeId != null)
				JNIEnv.CopyArray (typeId, native_typeId);
			return __ret;
		}
#pragma warning restore 0169
		...
		public virtual unsafe bool EqualId (byte[] typeId)
		{
			if (id_equalId_arrayB == IntPtr.Zero)
				id_equalId_arrayB = JNIEnv.GetMethodID (class_ref, "equalId", "([B)Z");
			IntPtr native_typeId = JNIEnv.NewArray (typeId);
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (native_typeId);
				...
				if (typeId != null) {
					JNIEnv.CopyArray (native_typeId, typeId);
					JNIEnv.DeleteLocalRef (native_typeId);
				}
			}
		}
