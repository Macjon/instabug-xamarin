...
namespace Org.Jcodec.Containers.Mps {
	...
	public partial class MTSDump : global::Org.Jcodec.Containers.Mps.MPSDump {
		...
		public unsafe MTSDump (global::Java.Nio.Channels.IReadableByteChannel ch, int targetGuid)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [1] = new JValue (targetGuid);
...
#pragma warning disable 0169
		...
		static int n_FillBuffer_Ljava_nio_ByteBuffer_ (IntPtr jnienv, IntPtr native__this, IntPtr native_dst)
		{
			...
			int __ret = __this.FillBuffer (dst);
			return __ret;
		}
#pragma warning restore 0169
		...
		public virtual unsafe int FillBuffer (global::Java.Nio.ByteBuffer dst)
		{
