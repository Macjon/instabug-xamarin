...
namespace Org.Jcodec.Codecs.Mpeg4.ES {
	...
	public partial class DecoderConfig : global::Org.Jcodec.Codecs.Mpeg4.ES.NodeDescriptor {
		...
		[Register (".ctor", "(II)V", "")]
		public unsafe DecoderConfig (int tag, int size)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (DecoderConfig)) {
					SetHandle (
		...
		public unsafe DecoderConfig (int objectType, int bufSize, int maxBitrate, int avgBitrate, params global:: Org.Jcodec.Codecs.Mpeg4.ES.Descriptor[] children)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				__args [0] = new JValue (objectType);
				__args [1] = new JValue (bufSize);
				__args [2] = new JValue (maxBitrate);
				__args [3] = new JValue (avgBitrate);
				__args [4] = new JValue (native_children);
				if (((object) this).GetType () != typeof (DecoderConfig)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(IIII[Lorg/jcodec/codecs/mpeg4/es/Descriptor;)V", __args),
							JniHandleOwnership.TransferLocalRef);
