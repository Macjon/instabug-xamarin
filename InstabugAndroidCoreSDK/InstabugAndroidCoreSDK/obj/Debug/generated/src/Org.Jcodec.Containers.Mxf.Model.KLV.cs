...
namespace Org.Jcodec.Containers.Mxf.Model {
	...
	public partial class KLV : global::Java.Lang.Object {
		...
		public unsafe KLV (global::Org.Jcodec.Containers.Mxf.Model.UL k, long len, long offset, long dataOffset)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [0] = new JValue (k);
				__args [1] = new JValue (len);
				__args [2] = new JValue (offset);
				__args [3] = new JValue (dataOffset);
				if (((object) this).GetType () != typeof (KLV)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Lorg/jcodec/containers/mxf/model/UL;JJJ)V", __args),
...
#pragma warning restore 0169
		...
		public static unsafe bool Matches (byte[] key1, byte[] key2, int len)
		{
			if (id_matches_arrayBarrayBI == IntPtr.Zero)
				id_matches_arrayBarrayBI = JNIEnv.GetStaticMethodID (class_ref, "matches", "([B[BI)Z");
			IntPtr native_key1 = JNIEnv.NewArray (key1);
			IntPtr native_key2 = JNIEnv.NewArray (key2);
			try {
				JValue* __args = stackalloc JValue [3];
				__args [0] = new JValue (native_key1);
				__args [1] = new JValue (native_key2);
				__args [2] = new JValue (len);
				bool __ret = JNIEnv.CallStaticBooleanMethod  (class_ref, id_matches_arrayBarrayBI, __args);
				return __ret;
			} finally {
				if (key1 != null) {
					JNIEnv.CopyArray (native_key1, key1);
					JNIEnv.DeleteLocalRef (native_key1);
				}
				if (key2 != null) {
					JNIEnv.CopyArray (native_key2, key2);
					JNIEnv.DeleteLocalRef (native_key2);
				}
			}
		}
		...
		public static unsafe global::Org.Jcodec.Containers.Mxf.Model.KLV ReadKL (global::Java.Nio.ByteBuffer buffer, long baseOffset)
		{
			...
			try {
				...
				__args [1] = new JValue (baseOffset);
