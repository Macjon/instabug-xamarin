...
namespace Org.Jcodec.Scale {
	...
	public partial class ImageConvert : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (ImageConvert)) {
					SetHandle (
		...
		public static unsafe sbyte RGB888toU4 (int r, int g, int b)
		{
		...
		public static unsafe sbyte RGB888toV4 (int r, int g, int b)
		{
		...
		public static unsafe sbyte RGB888toY4 (int r, int g, int b)
		{
		...
		public static unsafe void RGB888toYUV444 (global::Java.Nio.ByteBuffer rgb, global::Java.Nio.ByteBuffer Y, global::Java.Nio.ByteBuffer U, global::Java.Nio.ByteBuffer V)
		{
			...
			try {
				...
				__args [0] = new JValue (rgb);
				__args [1] = new JValue (Y);
				__args [2] = new JValue (U);
				__args [3] = new JValue (V);
		...
		public static unsafe void YUV444toRGB888 (int y, int u, int v, global::Java.Nio.ByteBuffer rgb)
		{
		...
		[Register ("crop", "(I)B", "")]
		public static unsafe sbyte Crop (int i)
		{
		...
		[Register ("icrop", "(I)I", "")]
		public static unsafe int Icrop (int i)
		{
		...
		public static unsafe sbyte Y_ccir_to_jpeg (sbyte y)
		{
		...
		public static unsafe sbyte Y_jpeg_to_ccir (sbyte y)
		{
		...
		public static unsafe int Ycbcr_to_rgb24 (int y, int cb, int cr)
		{
