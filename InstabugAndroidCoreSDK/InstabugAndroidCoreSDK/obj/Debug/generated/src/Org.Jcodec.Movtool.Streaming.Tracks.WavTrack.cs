...
namespace Org.Jcodec.Movtool.Streaming.Tracks {
	...
	public partial class WavTrack : global::Java.Lang.Object {
		...
		public partial class WavPacket : global::Java.Lang.Object {
			...
			public unsafe WavPacket (global::Org.Jcodec.Movtool.Streaming.Tracks.WavTrack __self, int frameNo, double pts, long offset, int dataLen)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					__args [1] = new JValue (frameNo);
					__args [2] = new JValue (pts);
					__args [3] = new JValue (offset);
					__args [4] = new JValue (dataLen);
