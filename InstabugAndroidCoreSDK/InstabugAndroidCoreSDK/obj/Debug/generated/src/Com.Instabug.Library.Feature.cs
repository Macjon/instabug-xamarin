...
namespace Com.Instabug.Library {
	...
	public sealed partial class Feature : global::Java.Lang.Enum {
		...
		static IntPtr DISCLAIMER_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.instabug.library']/class[@name='Feature']/field[@name='DISCLAIMER']"
		[Register ("DISCLAIMER")]
		public static global::Com.Instabug.Library.Feature Disclaimer {
			get {
				if (DISCLAIMER_jfieldId == IntPtr.Zero)
					DISCLAIMER_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "DISCLAIMER", "Lcom/instabug/library/Feature;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, DISCLAIMER_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Com.Instabug.Library.Feature> (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}
		...
		static IntPtr SURVEYS_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.instabug.library']/class[@name='Feature']/field[@name='SURVEYS']"
		[Register ("SURVEYS")]
		public static global::Com.Instabug.Library.Feature Surveys {
			get {
				if (SURVEYS_jfieldId == IntPtr.Zero)
					SURVEYS_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "SURVEYS", "Lcom/instabug/library/Feature;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, SURVEYS_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Com.Instabug.Library.Feature> (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}
		...
		static IntPtr USER_EVENTS_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.instabug.library']/class[@name='Feature']/field[@name='USER_EVENTS']"
		[Register ("USER_EVENTS")]
		public static global::Com.Instabug.Library.Feature UserEvents {
			get {
				if (USER_EVENTS_jfieldId == IntPtr.Zero)
					USER_EVENTS_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "USER_EVENTS", "Lcom/instabug/library/Feature;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, USER_EVENTS_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Com.Instabug.Library.Feature> (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}

		static IntPtr VIEW_HIERARCHY_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.instabug.library']/class[@name='Feature']/field[@name='VIEW_HIERARCHY']"
		[Register ("VIEW_HIERARCHY")]
		public static global::Com.Instabug.Library.Feature ViewHierarchy {
			get {
				if (VIEW_HIERARCHY_jfieldId == IntPtr.Zero)
					VIEW_HIERARCHY_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "VIEW_HIERARCHY", "Lcom/instabug/library/Feature;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, VIEW_HIERARCHY_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Com.Instabug.Library.Feature> (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}
