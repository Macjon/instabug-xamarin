...
namespace Org.Jcodec.Common.Model {
	...
	public partial class Frame : global::Java.Lang.Object {
		...
		public unsafe Frame (global::Org.Jcodec.Common.Model.Picture pic, global::Org.Jcodec.Common.Model.RationalLarge pts, global::Org.Jcodec.Common.Model.RationalLarge duration, global::Org.Jcodec.Common.Model.Rational pixelAspect, int frameNo, global::Org.Jcodec.Common.Model.TapeTimecode tapeTimecode, global::System.Collections.Generic.IList<string> messages)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;

			IntPtr native_messages = global::Android.Runtime.JavaList<string>.ToLocalJniHandle (messages);
			try {
				JValue* __args = stackalloc JValue [7];
				__args [0] = new JValue (pic);
				__args [1] = new JValue (pts);
				__args [2] = new JValue (duration);
				__args [3] = new JValue (pixelAspect);
				__args [4] = new JValue (frameNo);
				__args [5] = new JValue (tapeTimecode);
				__args [6] = new JValue (native_messages);
				if (((object) this).GetType () != typeof (Frame)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Lorg/jcodec/common/model/Picture;Lorg/jcodec/common/model/RationalLarge;Lorg/jcodec/common/model/RationalLarge;Lorg/jcodec/common/model/Rational;ILorg/jcodec/common/model/TapeTimecode;Ljava/util/List;)V", __args),
