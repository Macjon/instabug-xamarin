...
#pragma warning restore 0169
		...
		public partial class MPEGTrackMetadata : global::Java.Lang.Object {
			...
			public unsafe MPEGTrackMetadata (global::Org.Jcodec.Codecs.Mpeg12.MPSMediaInfo __self, int streamId)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
					return;
...
#pragma warning disable 0169
		...
		static void n_Pes_Ljava_nio_ByteBuffer_JII (IntPtr jnienv, IntPtr native__this, IntPtr native_pesBuffer, long start, int pesLen, int stream)
		{
			global::Org.Jcodec.Codecs.Mpeg12.MPSMediaInfo __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Codecs.Mpeg12.MPSMediaInfo> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Java.Nio.ByteBuffer pesBuffer = global::Java.Lang.Object.GetObject<global::Java.Nio.ByteBuffer> (native_pesBuffer, JniHandleOwnership.DoNotTransfer);
			__this.Pes (pesBuffer, start, pesLen, stream);
		}
#pragma warning restore 0169
		...
		protected override unsafe void Pes (global::Java.Nio.ByteBuffer pesBuffer, long start, int pesLen, int stream)
		{
			...
			try {
				...
				__args [0] = new JValue (pesBuffer);
				__args [1] = new JValue (start);
				__args [2] = new JValue (pesLen);
				__args [3] = new JValue (stream);
