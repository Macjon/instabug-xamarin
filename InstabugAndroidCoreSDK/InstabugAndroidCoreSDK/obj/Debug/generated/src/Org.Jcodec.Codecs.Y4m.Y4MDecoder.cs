...
#pragma warning disable 0169
		...
		static IntPtr n_NextFrame_arrayarrayI (IntPtr jnienv, IntPtr native__this, IntPtr native_buffer)
		{
			global::Org.Jcodec.Codecs.Y4m.Y4MDecoder __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Codecs.Y4m.Y4MDecoder> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			int[][] buffer = (int[][]) JNIEnv.GetArray (native_buffer, JniHandleOwnership.DoNotTransfer, typeof (int[]));
			IntPtr __ret = JNIEnv.ToLocalJniHandle (__this.NextFrame (buffer));
			if (buffer != null)
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Org.Jcodec.Common.Model.Picture NextFrame (int[][] buffer)
		{
