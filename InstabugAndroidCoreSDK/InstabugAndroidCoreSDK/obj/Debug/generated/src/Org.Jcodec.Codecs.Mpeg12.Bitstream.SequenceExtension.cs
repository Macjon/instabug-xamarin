...
namespace Org.Jcodec.Codecs.Mpeg12.Bitstream {
	...
	public partial class SequenceExtension : global::Java.Lang.Object, global::Org.Jcodec.Codecs.Mpeg12.Bitstream.IMPEGHeader {
		...
		public unsafe SequenceExtension (int profile_and_level, int progressive_sequence, int chroma_format, int horizontal_size_extension, int vertical_size_extension, int bit_rate_extension, int vbv_buffer_size_extension, int low_delay, int frame_rate_extension_n, int frame_rate_extension_d)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [0] = new JValue (profile_and_level);
				__args [1] = new JValue (progressive_sequence);
				__args [2] = new JValue (chroma_format);
				__args [3] = new JValue (horizontal_size_extension);
				__args [4] = new JValue (vertical_size_extension);
				__args [5] = new JValue (bit_rate_extension);
				__args [6] = new JValue (vbv_buffer_size_extension);
				__args [7] = new JValue (low_delay);
				__args [8] = new JValue (frame_rate_extension_n);
				__args [9] = new JValue (frame_rate_extension_d);
		...
		public static unsafe global::Org.Jcodec.Codecs.Mpeg12.Bitstream.SequenceExtension Read (global::Org.Jcodec.Common.IO.BitReader @in)
		{
