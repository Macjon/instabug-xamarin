...
namespace Org.Jcodec.Common.Dct {
	...
	public abstract partial class DCT : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (DCT)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		static void n_DecodeAll_arrayarrayI (IntPtr jnienv, IntPtr native__this, IntPtr native_src)
		{
			global::Org.Jcodec.Common.Dct.DCT __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Common.Dct.DCT> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			int[][] src = (int[][]) JNIEnv.GetArray (native_src, JniHandleOwnership.DoNotTransfer, typeof (int[]));
			__this.DecodeAll (src);
			if (src != null)
...
#pragma warning restore 0169
		...
		public virtual unsafe void DecodeAll (int[][] src)
		{
...
#pragma warning disable 0169
		...
		static IntPtr n_Encode_arrayB (IntPtr jnienv, IntPtr native__this, IntPtr native_orig)
		{
			global::Org.Jcodec.Common.Dct.DCT __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Common.Dct.DCT> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			byte[] orig = (byte[]) JNIEnv.GetArray (native_orig, JniHandleOwnership.DoNotTransfer, typeof (byte));
			IntPtr __ret = JNIEnv.NewArray (__this.Encode (orig));
			if (orig != null)
...
#pragma warning restore 0169
		...
		public virtual unsafe short[] Encode (byte[] orig)
		{
