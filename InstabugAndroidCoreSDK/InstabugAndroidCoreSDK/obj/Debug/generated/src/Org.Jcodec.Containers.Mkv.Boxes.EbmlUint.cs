...
namespace Org.Jcodec.Containers.Mkv.Boxes {
	...
	public partial class EbmlUint : global::Org.Jcodec.Containers.Mkv.Boxes.EbmlBin {
		...
		[Register (".ctor", "([B)V", "")]
		public unsafe EbmlUint (byte[] id)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (EbmlUint)) {
					SetHandle (
		...
		[Register (".ctor", "([BJ)V", "")]
		public unsafe EbmlUint (byte[] id, long value)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
		...
		public static unsafe int CalculatePayloadSize (long value)
		{
...
#pragma warning restore 0169
		...
		public static unsafe byte[] LongToBytes (long value)
		{
