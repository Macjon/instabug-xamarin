...
namespace Org.Jcodec.Common.Model {
	...
	public partial class TapeTimecode : global::Java.Lang.Object {
		...
		public unsafe TapeTimecode (short hour, sbyte minute, sbyte second, sbyte frame, bool dropFrame)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [0] = new JValue (hour);
				__args [1] = new JValue (minute);
				__args [2] = new JValue (second);
				__args [3] = new JValue (frame);
				__args [4] = new JValue (dropFrame);
				if (((object) this).GetType () != typeof (TapeTimecode)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(SBBBZ)V", __args),
