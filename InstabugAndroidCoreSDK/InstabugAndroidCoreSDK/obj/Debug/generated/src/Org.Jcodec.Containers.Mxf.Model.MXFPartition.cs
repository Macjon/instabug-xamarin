...
namespace Org.Jcodec.Containers.Mxf.Model {
	...
	public partial class MXFPartition : global::Java.Lang.Object {
		...
		public unsafe MXFPartition (global::Org.Jcodec.Containers.Mxf.Model.MXFPartitionPack pack, long essenceFilePos, bool closed, bool complete, long essenceLength)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [0] = new JValue (pack);
				__args [1] = new JValue (essenceFilePos);
				__args [2] = new JValue (closed);
				__args [3] = new JValue (complete);
				__args [4] = new JValue (essenceLength);
...
#pragma warning restore 0169
		...
		public static unsafe global::Org.Jcodec.Containers.Mxf.Model.MXFPartition Read (global::Org.Jcodec.Containers.Mxf.Model.UL ul, global::Java.Nio.ByteBuffer bb, long packSize, long nextPartition)
		{
			...
			try {
				...
				__args [1] = new JValue (bb);
				__args [2] = new JValue (packSize);
				__args [3] = new JValue (nextPartition);
