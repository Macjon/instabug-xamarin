...
namespace Org.Jcodec.Containers.Mp4 {
	...
	public sealed partial class TrackType : global::Java.Lang.Enum {
		...
		public static unsafe global::Org.Jcodec.Containers.Mp4.TrackType FromHandler (string handler)
		{
			...
			IntPtr native_handler = JNIEnv.NewString (handler);
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (native_handler);
				...
				JNIEnv.DeleteLocalRef (native_handler);
			}
		}
		...
		public static unsafe global::Org.Jcodec.Containers.Mp4.TrackType ValueOf (string name)
		{
