	...
	public partial class WavHeader : global::Java.Lang.Object {
		...
		public partial class FmtChunk : global::Java.Lang.Object {
				...
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					if (((object) this).GetType () != typeof (FmtChunk)) {
						SetHandle (
			...
			public unsafe FmtChunk (global::Org.Jcodec.Codecs.Wav.WavHeader.FmtChunk other)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
					return;
				...
				try {
					...
					if (((object) this).GetType () != typeof (FmtChunk)) {
						SetHandle (
								global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Lorg/jcodec/codecs/wav/WavHeader$FmtChunk;)V", __args),
								JniHandleOwnership.TransferLocalRef);
			...
			public unsafe FmtChunk (short audioFormat, short numChannels, int sampleRate, int byteRate, short blockAlign, short bitsPerSample)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
					return;
				...
				try {
					...
					__args [0] = new JValue (audioFormat);
					__args [1] = new JValue (numChannels);
					__args [2] = new JValue (sampleRate);
					__args [3] = new JValue (byteRate);
					__args [4] = new JValue (blockAlign);
					__args [5] = new JValue (bitsPerSample);
					if (((object) this).GetType () != typeof (FmtChunk)) {
						SetHandle (
								global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(SSIISS)V", __args),
								JniHandleOwnership.TransferLocalRef);
			...
			public static unsafe global::Org.Jcodec.Codecs.Wav.WavHeader.FmtChunk Get (global::Java.Nio.ByteBuffer bb)
			{
...
#pragma warning disable 0169
			...
			static void n_Put_Ljava_nio_ByteBuffer_ (IntPtr jnienv, IntPtr native__this, IntPtr native_bb)
			{
...
#pragma warning restore 0169
			...
			public virtual unsafe void Put (global::Java.Nio.ByteBuffer bb)
			{
...
#pragma warning restore 0169
		...
		public partial class FmtChunkExtended : global::Org.Jcodec.Codecs.Wav.WavHeader.FmtChunk {
			...
			public unsafe FmtChunkExtended (global::Org.Jcodec.Codecs.Wav.WavHeader.FmtChunk fmtChunk, short cbSize, short bitsPerCodedSample, int channelLayout, int guid)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
					return;
				...
				try {
					...
					__args [0] = new JValue (fmtChunk);
					__args [1] = new JValue (cbSize);
					__args [2] = new JValue (bitsPerCodedSample);
					__args [3] = new JValue (channelLayout);
					__args [4] = new JValue (guid);
					if (((object) this).GetType () != typeof (FmtChunkExtended)) {
						SetHandle (
								global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Lorg/jcodec/codecs/wav/WavHeader$FmtChunk;SSII)V", __args),
								JniHandleOwnership.TransferLocalRef);
			...
			public unsafe FmtChunkExtended (global::Org.Jcodec.Codecs.Wav.WavHeader.FmtChunkExtended fmt)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
					return;
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (fmt);
					if (((object) this).GetType () != typeof (FmtChunkExtended)) {
						SetHandle (
								global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Lorg/jcodec/codecs/wav/WavHeader$FmtChunkExtended;)V", __args),
								JniHandleOwnership.TransferLocalRef);
...
#pragma warning restore 0169
			...
			public static unsafe global::Org.Jcodec.Codecs.Wav.WavHeader.FmtChunk Read (global::Java.Nio.ByteBuffer bb)
			{
		...
		public unsafe WavHeader (string chunkId, int chunkSize, string format, global::Org.Jcodec.Codecs.Wav.WavHeader.FmtChunk fmt, int dataOffset, long dataSize)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;

			IntPtr native_chunkId = JNIEnv.NewString (chunkId);
			IntPtr native_format = JNIEnv.NewString (format);
			try {
				JValue* __args = stackalloc JValue [6];
				__args [0] = new JValue (native_chunkId);
				__args [1] = new JValue (chunkSize);
				__args [2] = new JValue (native_format);
				__args [3] = new JValue (fmt);
				__args [4] = new JValue (dataOffset);
				__args [5] = new JValue (dataSize);
				if (((object) this).GetType () != typeof (WavHeader)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Ljava/lang/String;ILjava/lang/String;Lorg/jcodec/codecs/wav/WavHeader$FmtChunk;IJ)V", __args),
							JniHandleOwnership.TransferLocalRef);
				...
				JNIEnv.DeleteLocalRef (native_chunkId);
		...
		public unsafe WavHeader (global::Org.Jcodec.Codecs.Wav.WavHeader header)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				if (((object) this).GetType () != typeof (WavHeader)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Lorg/jcodec/codecs/wav/WavHeader;)V", __args),
							JniHandleOwnership.TransferLocalRef);
		...
		public static unsafe long CalcDataSize (int numChannels, int bytesPerSample, long samples)
		{
			if (id_calcDataSize_IIJ == IntPtr.Zero)
				id_calcDataSize_IIJ = JNIEnv.GetStaticMethodID (class_ref, "calcDataSize", "(IIJ)J");
			try {
				JValue* __args = stackalloc JValue [3];
				__args [0] = new JValue (numChannels);
				__args [1] = new JValue (bytesPerSample);
				__args [2] = new JValue (samples);
		...
		public static unsafe global::Org.Jcodec.Codecs.Wav.WavHeader CopyWithChannels (global::Org.Jcodec.Codecs.Wav.WavHeader header, int channels)
		{
		...
		public static unsafe global::Org.Jcodec.Codecs.Wav.WavHeader CopyWithRate (global::Org.Jcodec.Codecs.Wav.WavHeader header, int rate)
		{
...
#pragma warning restore 0169
		...
		public static unsafe global::Org.Jcodec.Codecs.Wav.WavHeader MultiChannelWav (params global:: Java.IO.File[] wavs)
		{
			...
			IntPtr native_wavs = JNIEnv.NewArray (wavs);
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (native_wavs);
				...
				if (wavs != null) {
					JNIEnv.CopyArray (native_wavs, wavs);
					JNIEnv.DeleteLocalRef (native_wavs);
				}
			}
		}
		...
		public static unsafe global::Org.Jcodec.Codecs.Wav.WavHeader MultiChannelWav (global::System.Collections.Generic.IList<global::Java.IO.File> wavs)
		{
			...
			IntPtr native_wavs = global::Android.Runtime.JavaList<global::Java.IO.File>.ToLocalJniHandle (wavs);
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (native_wavs);
		...
		public static unsafe global::Org.Jcodec.Codecs.Wav.WavHeader MultiChannelWav (params global:: Org.Jcodec.Codecs.Wav.WavHeader[] wavs)
		{
		...
		public static unsafe global::Org.Jcodec.Codecs.Wav.WavHeader Read (global::Java.IO.File file)
		{
		...
		public static unsafe global::Org.Jcodec.Codecs.Wav.WavHeader Read (global::Java.Nio.Channels.IReadableByteChannel @in)
		{
		...
		public static unsafe global::Org.Jcodec.Codecs.Wav.WavHeader Stereo48k (long samples)
		{
...
#pragma warning disable 0169
		...
		static void n_Write_Ljava_nio_channels_WritableByteChannel_ (IntPtr jnienv, IntPtr native__this, IntPtr native__out)
		{
			global::Org.Jcodec.Codecs.Wav.WavHeader __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Codecs.Wav.WavHeader> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Java.Nio.Channels.IWritableByteChannel @out = (global::Java.Nio.Channels.IWritableByteChannel)global::Java.Lang.Object.GetObject<global::Java.Nio.Channels.IWritableByteChannel> (native__out, JniHandleOwnership.DoNotTransfer);
			__this.Write (@out);
		}
#pragma warning restore 0169
		...
		public virtual unsafe void Write (global::Java.Nio.Channels.IWritableByteChannel @out)
		{
