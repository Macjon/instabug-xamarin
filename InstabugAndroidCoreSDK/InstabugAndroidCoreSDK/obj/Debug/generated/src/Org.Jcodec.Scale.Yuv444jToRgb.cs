...
namespace Org.Jcodec.Scale {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.jcodec.scale']/class[@name='Yuv444jToRgb']"
	[global::Android.Runtime.Register ("org/jcodec/scale/Yuv444jToRgb", DoNotGenerateAcw=true)]
	public partial class Yuv444jToRgb : global::Java.Lang.Object, global::Org.Jcodec.Scale.ITransform {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/jcodec/scale/Yuv444jToRgb", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (Yuv444jToRgb); }
		}

		protected Yuv444jToRgb (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.jcodec.scale']/class[@name='Yuv444jToRgb']/constructor[@name='Yuv444jToRgb' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe Yuv444jToRgb ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (Yuv444jToRgb)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Org.Jcodec.Scale.Yuv444jToRgb __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Scale.Yuv444jToRgb> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jcodec.scale']/class[@name='Yuv444jToRgb']/method[@name='transform' and count(parameter)=2 and parameter[1][@type='org.jcodec.common.model.Picture'] and parameter[2][@type='org.jcodec.common.model.Picture']]"
