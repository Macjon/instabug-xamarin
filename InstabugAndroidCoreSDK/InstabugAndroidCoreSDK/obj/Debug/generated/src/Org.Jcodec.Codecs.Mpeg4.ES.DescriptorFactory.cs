...
namespace Org.Jcodec.Codecs.Mpeg4.ES {
	...
	public partial class DescriptorFactory : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (DescriptorFactory)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		static IntPtr n_ByTag_I (IntPtr jnienv, IntPtr native__this, int tag)
		{
			...
			return JNIEnv.ToLocalJniHandle (__this.ByTag (tag));
		}
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Lang.Class ByTag (int tag)
		{
