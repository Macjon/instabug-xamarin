...
namespace Org.Jcodec.Codecs.Wav {
	...
	public partial class WavInput : global::Java.Lang.Object, global::Java.IO.ICloseable {
		...
		public partial class File : global::Org.Jcodec.Codecs.Wav.WavInput {
			...
			public unsafe File (global::Java.IO.File f)
		...
		public partial class Source : global::Java.Lang.Object, global::Java.IO.ICloseable {
			...
			[Register (".ctor", "(Ljava/io/File;)V", "")]
			public unsafe Source (global::Java.IO.File file)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
					return;
			...
			public unsafe Source (global::Java.Nio.Channels.IReadableByteChannel ch)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
					return;
			...
			public unsafe Source (global::Org.Jcodec.Codecs.Wav.WavInput src)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
					return;
...
#pragma warning disable 0169
			...
			static int n_Read_arrayII (IntPtr jnienv, IntPtr native__this, IntPtr native_samples, int max)
			{
				global::Org.Jcodec.Codecs.Wav.WavInput.Source __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Codecs.Wav.WavInput.Source> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				int[] samples = (int[]) JNIEnv.GetArray (native_samples, JniHandleOwnership.DoNotTransfer, typeof (int));
				int __ret = __this.Read (samples, max);
				if (samples != null)
...
#pragma warning restore 0169
			...
			public virtual unsafe int Read (int[] samples, int max)
			{
				...
				try {
					...
					__args [0] = new JValue (native_samples);
...
#pragma warning disable 0169
			...
			static int n_Read_Ljava_nio_FloatBuffer_ (IntPtr jnienv, IntPtr native__this, IntPtr native_samples)
			{
				global::Org.Jcodec.Codecs.Wav.WavInput.Source __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Codecs.Wav.WavInput.Source> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				global::Java.Nio.FloatBuffer samples = global::Java.Lang.Object.GetObject<global::Java.Nio.FloatBuffer> (native_samples, JniHandleOwnership.DoNotTransfer);
				int __ret = __this.Read (samples);
				return __ret;
			}
#pragma warning restore 0169
			...
			public virtual unsafe int Read (global::Java.Nio.FloatBuffer samples)
			{
		...
		[Register (".ctor", "(Ljava/nio/channels/ReadableByteChannel;)V", "")]
		public unsafe WavInput (global::Java.Nio.Channels.IReadableByteChannel @in)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		static int n_Read_Ljava_nio_ByteBuffer_ (IntPtr jnienv, IntPtr native__this, IntPtr native_buf)
		{
			global::Org.Jcodec.Codecs.Wav.WavInput __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Codecs.Wav.WavInput> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe int Read (global::Java.Nio.ByteBuffer buf)
		{
