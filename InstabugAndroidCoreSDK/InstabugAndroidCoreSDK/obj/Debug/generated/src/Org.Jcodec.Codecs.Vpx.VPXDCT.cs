...
namespace Org.Jcodec.Codecs.Vpx {
	...
	public partial class VPXDCT : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (VPXDCT)) {
					SetHandle (
		...
		public static unsafe void Fdct4x4 (int[] coef)
		{
			if (id_fdct4x4_arrayI == IntPtr.Zero)
				id_fdct4x4_arrayI = JNIEnv.GetStaticMethodID (class_ref, "fdct4x4", "([I)V");
			IntPtr native_coef = JNIEnv.NewArray (coef);
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (native_coef);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_fdct4x4_arrayI, __args);
			} finally {
				if (coef != null) {
					JNIEnv.CopyArray (native_coef, coef);
					JNIEnv.DeleteLocalRef (native_coef);
				}
			}
		}
		...
		public static unsafe void Idct4x4 (int[] coef)
		{
		...
		public static unsafe void Iwalsh4x4 (int[] coef)
		{
		...
		public static unsafe void Walsh4x4 (int[] coef)
		{
