...
#pragma warning disable 0169
			static Delegate GetSetSurveysAutoShowing_ZHandler ()
			{
				if (cb_setSurveysAutoShowing_Z == null)
					cb_setSurveysAutoShowing_Z = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, bool, IntPtr>) n_SetSurveysAutoShowing_Z);
				return cb_setSurveysAutoShowing_Z;
			}

			static IntPtr n_SetSurveysAutoShowing_Z (IntPtr jnienv, IntPtr native__this, bool p0)
			{
				global::Com.Instabug.Library.Instabug.Builder __this = global::Java.Lang.Object.GetObject<global::Com.Instabug.Library.Instabug.Builder> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				return JNIEnv.ToLocalJniHandle (__this.SetSurveysAutoShowing (p0));
			}
#pragma warning restore 0169

			static IntPtr id_setSurveysAutoShowing_Z;
			// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug.Builder']/method[@name='setSurveysAutoShowing' and count(parameter)=1 and parameter[1][@type='boolean']]"
			[Obsolete (@"deprecated")]
			[Register ("setSurveysAutoShowing", "(Z)Lcom/instabug/library/Instabug$Builder;", "GetSetSurveysAutoShowing_ZHandler")]
			public virtual unsafe global::Com.Instabug.Library.Instabug.Builder SetSurveysAutoShowing (bool p0)
			{
				if (id_setSurveysAutoShowing_Z == IntPtr.Zero)
					id_setSurveysAutoShowing_Z = JNIEnv.GetMethodID (class_ref, "setSurveysAutoShowing", "(Z)Lcom/instabug/library/Instabug$Builder;");
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (p0);

					if (((object) this).GetType () == ThresholdType)
						return global::Java.Lang.Object.GetObject<global::Com.Instabug.Library.Instabug.Builder> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_setSurveysAutoShowing_Z, __args), JniHandleOwnership.TransferLocalRef);
					else
						return global::Java.Lang.Object.GetObject<global::Com.Instabug.Library.Instabug.Builder> (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setSurveysAutoShowing", "(Z)Lcom/instabug/library/Instabug$Builder;"), __args), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
...
#pragma warning restore 0169
		...
		public static unsafe global::Android.Content.Context ApplicationContext {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='getApplicationContext' and count(parameter)=0]"
		...
		static IntPtr id_setCommentFieldRequired_Z;
		public static unsafe bool CommentFieldRequired {
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setCommentFieldRequired' and count(parameter)=1 and parameter[1][@type='boolean']]"
			[Register ("setCommentFieldRequired", "(Z)V", "GetSetCommentFieldRequired_ZHandler")]
			set {
				if (id_setCommentFieldRequired_Z == IntPtr.Zero)
					id_setCommentFieldRequired_Z = JNIEnv.GetStaticMethodID (class_ref, "setCommentFieldRequired", "(Z)V");
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallStaticVoidMethod  (class_ref, id_setCommentFieldRequired_Z, __args);
				} finally {
				}
			}
		}

		static IntPtr id_getFirstRunAt;
		public static unsafe global::Java.Util.Date FirstRunAt {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='getFirstRunAt' and count(parameter)=0]"
			[Register ("getFirstRunAt", "()Ljava/util/Date;", "GetGetFirstRunAtHandler")]
			get {
				if (id_getFirstRunAt == IntPtr.Zero)
					id_getFirstRunAt = JNIEnv.GetStaticMethodID (class_ref, "getFirstRunAt", "()Ljava/util/Date;");
				try {
					return global::Java.Lang.Object.GetObject<global::Java.Util.Date> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getFirstRunAt), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
		...
		public static unsafe bool HasValidSurveys {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='hasValidSurveys' and count(parameter)=0]"
		...
		static IntPtr id_isAppOnForeground;
		public static unsafe bool IsAppOnForeground {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='isAppOnForeground' and count(parameter)=0]"
			[Register ("isAppOnForeground", "()Z", "GetIsAppOnForegroundHandler")]
			get {
				if (id_isAppOnForeground == IntPtr.Zero)
					id_isAppOnForeground = JNIEnv.GetStaticMethodID (class_ref, "isAppOnForeground", "()Z");
				try {
					return JNIEnv.CallStaticBooleanMethod  (class_ref, id_isAppOnForeground);
				} finally {
				}
			}
		}

		static IntPtr id_isBuilt;
		public static unsafe bool IsBuilt {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='isBuilt' and count(parameter)=0]"
			[Register ("isBuilt", "()Z", "GetIsBuiltHandler")]
			get {
				if (id_isBuilt == IntPtr.Zero)
					id_isBuilt = JNIEnv.GetStaticMethodID (class_ref, "isBuilt", "()Z");
				try {
					return JNIEnv.CallStaticBooleanMethod  (class_ref, id_isBuilt);
				} finally {
				}
			}
		}
		...
		public static unsafe int RequestedOrientation {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='getRequestedOrientation' and count(parameter)=0]"
			[Register ("getRequestedOrientation", "()I", "GetGetRequestedOrientationHandler")]
			get {
				if (id_getRequestedOrientation == IntPtr.Zero)
					id_getRequestedOrientation = JNIEnv.GetStaticMethodID (class_ref, "getRequestedOrientation", "()I");
				try {
					return JNIEnv.CallStaticIntMethod  (class_ref, id_getRequestedOrientation);
				} finally {
				}
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setRequestedOrientation' and count(parameter)=1 and parameter[1][@type='int']]"
			[Register ("setRequestedOrientation", "(I)V", "GetSetRequestedOrientation_IHandler")]
			set {
				if (id_setRequestedOrientation_I == IntPtr.Zero)
					id_setRequestedOrientation_I = JNIEnv.GetStaticMethodID (class_ref, "setRequestedOrientation", "(I)V");
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallStaticVoidMethod  (class_ref, id_setRequestedOrientation_I, __args);
				} finally {
				}
			}
		}
		...
		static IntPtr id_setState_Lcom_instabug_library_InstabugState_;
		public static unsafe global::Com.Instabug.Library.InstabugState State {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='getState' and count(parameter)=0]"
			[Register ("getState", "()Lcom/instabug/library/InstabugState;", "GetGetStateHandler")]
			get {
				if (id_getState == IntPtr.Zero)
					id_getState = JNIEnv.GetStaticMethodID (class_ref, "getState", "()Lcom/instabug/library/InstabugState;");
				try {
					return global::Java.Lang.Object.GetObject<global::Com.Instabug.Library.InstabugState> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getState), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setState' and count(parameter)=1 and parameter[1][@type='com.instabug.library.InstabugState']]"
			[Register ("setState", "(Lcom/instabug/library/InstabugState;)V", "GetSetState_Lcom_instabug_library_InstabugState_Handler")]
			set {
				if (id_setState_Lcom_instabug_library_InstabugState_ == IntPtr.Zero)
					id_setState_Lcom_instabug_library_InstabugState_ = JNIEnv.GetStaticMethodID (class_ref, "setState", "(Lcom/instabug/library/InstabugState;)V");
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallStaticVoidMethod  (class_ref, id_setState_Lcom_instabug_library_InstabugState_, __args);
				} finally {
				}
			}
		}
		...
		public static unsafe global::Com.Instabug.Library.InstabugColorTheme Theme {
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setTheme' and count(parameter)=1 and parameter[1][@type='com.instabug.library.InstabugColorTheme']]"
			[Register ("setTheme", "(Lcom/instabug/library/InstabugColorTheme;)V", "GetSetTheme_Lcom_instabug_library_InstabugColorTheme_Handler")]
			set {
				if (id_setTheme_Lcom_instabug_library_InstabugColorTheme_ == IntPtr.Zero)
					id_setTheme_Lcom_instabug_library_InstabugColorTheme_ = JNIEnv.GetStaticMethodID (class_ref, "setTheme", "(Lcom/instabug/library/InstabugColorTheme;)V");
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallStaticVoidMethod  (class_ref, id_setTheme_Lcom_instabug_library_InstabugColorTheme_, __args);
				} finally {
				}
			}
		}
		...
		static IntPtr id_addFileAttachment_arrayBLjava_lang_String_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='addFileAttachment' and count(parameter)=2 and parameter[1][@type='byte[]'] and parameter[2][@type='java.lang.String']]"
		[Register ("addFileAttachment", "([BLjava/lang/String;)V", "")]
		public static unsafe void AddFileAttachment (byte[] p0, string p1)
		{
			if (id_addFileAttachment_arrayBLjava_lang_String_ == IntPtr.Zero)
				id_addFileAttachment_arrayBLjava_lang_String_ = JNIEnv.GetStaticMethodID (class_ref, "addFileAttachment", "([BLjava/lang/String;)V");
			...
			try {
				...
				__args [1] = new JValue (native_p1);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_addFileAttachment_arrayBLjava_lang_String_, __args);
			} finally {
				if (p0 != null) {
		...
		static IntPtr id_resetRequestedOrientation;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='resetRequestedOrientation' and count(parameter)=0]"
		[Register ("resetRequestedOrientation", "()V", "")]
		public static unsafe void ResetRequestedOrientation ()
		{
			if (id_resetRequestedOrientation == IntPtr.Zero)
				id_resetRequestedOrientation = JNIEnv.GetStaticMethodID (class_ref, "resetRequestedOrientation", "()V");
			try {
				JNIEnv.CallStaticVoidMethod  (class_ref, id_resetRequestedOrientation);
			} finally {
			}
		}
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setAfterShowingSurveyRunnable' and count(parameter)=1 and parameter[1][@type='java.lang.Runnable']]"
		[Register ("setAfterShowingSurveyRunnable", "(Ljava/lang/Runnable;)V", "")]
		public static unsafe void SetAfterShowingSurveyRunnable (global::Java.Lang.IRunnable p0)
		{
		...
		static IntPtr id_setEmailFieldRequired_Z;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setEmailFieldRequired' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("setEmailFieldRequired", "(Z)V", "")]
		public static unsafe void SetEmailFieldRequired (bool p0)
		{
			if (id_setEmailFieldRequired_Z == IntPtr.Zero)
				id_setEmailFieldRequired_Z = JNIEnv.GetStaticMethodID (class_ref, "setEmailFieldRequired", "(Z)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setEmailFieldRequired_Z, __args);
			} finally {
			}
		}

		static IntPtr id_setEmailFieldVisibility_Z;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setEmailFieldVisibility' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("setEmailFieldVisibility", "(Z)V", "")]
		public static unsafe void SetEmailFieldVisibility (bool p0)
		{
			if (id_setEmailFieldVisibility_Z == IntPtr.Zero)
				id_setEmailFieldVisibility_Z = JNIEnv.GetStaticMethodID (class_ref, "setEmailFieldVisibility", "(Z)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setEmailFieldVisibility_Z, __args);
			} finally {
			}
		}

		static IntPtr id_setEnableInAppNotificationSound_Z;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setEnableInAppNotificationSound' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("setEnableInAppNotificationSound", "(Z)V", "")]
		public static unsafe void SetEnableInAppNotificationSound (bool p0)
		{
			if (id_setEnableInAppNotificationSound_Z == IntPtr.Zero)
				id_setEnableInAppNotificationSound_Z = JNIEnv.GetStaticMethodID (class_ref, "setEnableInAppNotificationSound", "(Z)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setEnableInAppNotificationSound_Z, __args);
			} finally {
			}
		}

		static IntPtr id_setEnableSystemNotificationSound_Z;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setEnableSystemNotificationSound' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("setEnableSystemNotificationSound", "(Z)V", "")]
		public static unsafe void SetEnableSystemNotificationSound (bool p0)
		{
			if (id_setEnableSystemNotificationSound_Z == IntPtr.Zero)
				id_setEnableSystemNotificationSound_Z = JNIEnv.GetStaticMethodID (class_ref, "setEnableSystemNotificationSound", "(Z)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setEnableSystemNotificationSound_Z, __args);
			} finally {
			}
		}
		...
		static IntPtr id_setFloatingButtonEdge_Lcom_instabug_library_invocation_util_InstabugFloatingButtonEdge_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setFloatingButtonEdge' and count(parameter)=1 and parameter[1][@type='com.instabug.library.invocation.util.InstabugFloatingButtonEdge']]"
		[Register ("setFloatingButtonEdge", "(Lcom/instabug/library/invocation/util/InstabugFloatingButtonEdge;)V", "")]
		public static unsafe void SetFloatingButtonEdge (global::Com.Instabug.Library.Invocation.Util.InstabugFloatingButtonEdge p0)
		{
			if (id_setFloatingButtonEdge_Lcom_instabug_library_invocation_util_InstabugFloatingButtonEdge_ == IntPtr.Zero)
				id_setFloatingButtonEdge_Lcom_instabug_library_invocation_util_InstabugFloatingButtonEdge_ = JNIEnv.GetStaticMethodID (class_ref, "setFloatingButtonEdge", "(Lcom/instabug/library/invocation/util/InstabugFloatingButtonEdge;)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setFloatingButtonEdge_Lcom_instabug_library_invocation_util_InstabugFloatingButtonEdge_, __args);
			} finally {
			}
		}

		static IntPtr id_setFloatingButtonOffsetFromTop_I;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setFloatingButtonOffsetFromTop' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("setFloatingButtonOffsetFromTop", "(I)V", "")]
		public static unsafe void SetFloatingButtonOffsetFromTop (int p0)
		{
			if (id_setFloatingButtonOffsetFromTop_I == IntPtr.Zero)
				id_setFloatingButtonOffsetFromTop_I = JNIEnv.GetStaticMethodID (class_ref, "setFloatingButtonOffsetFromTop", "(I)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setFloatingButtonOffsetFromTop_I, __args);
			} finally {
			}
		}
		...
		static IntPtr id_setIntroMessageEnabled_Z;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setIntroMessageEnabled' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("setIntroMessageEnabled", "(Z)V", "")]
		public static unsafe void SetIntroMessageEnabled (bool p0)
		{
			if (id_setIntroMessageEnabled_Z == IntPtr.Zero)
				id_setIntroMessageEnabled_Z = JNIEnv.GetStaticMethodID (class_ref, "setIntroMessageEnabled", "(Z)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setIntroMessageEnabled_Z, __args);
			} finally {
			}
		}

		static IntPtr id_setLocale_Ljava_util_Locale_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setLocale' and count(parameter)=1 and parameter[1][@type='java.util.Locale']]"
		[Register ("setLocale", "(Ljava/util/Locale;)V", "")]
		public static unsafe void SetLocale (global::Java.Util.Locale p0)
		{
			if (id_setLocale_Ljava_util_Locale_ == IntPtr.Zero)
				id_setLocale_Ljava_util_Locale_ = JNIEnv.GetStaticMethodID (class_ref, "setLocale", "(Ljava/util/Locale;)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setLocale_Ljava_util_Locale_, __args);
			} finally {
			}
		}
		...
		static IntPtr id_setNotificationIcon_I;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setNotificationIcon' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("setNotificationIcon", "(I)V", "")]
		public static unsafe void SetNotificationIcon (int p0)
		{
			if (id_setNotificationIcon_I == IntPtr.Zero)
				id_setNotificationIcon_I = JNIEnv.GetStaticMethodID (class_ref, "setNotificationIcon", "(I)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setNotificationIcon_I, __args);
			} finally {
			}
		}
		...
		static IntPtr id_setPreInvocation_Ljava_lang_Runnable_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setPreInvocation' and count(parameter)=1 and parameter[1][@type='java.lang.Runnable']]"
		[Register ("setPreInvocation", "(Ljava/lang/Runnable;)V", "")]
		public static unsafe void SetPreInvocation (global::Java.Lang.IRunnable p0)
		{
			if (id_setPreInvocation_Ljava_lang_Runnable_ == IntPtr.Zero)
				id_setPreInvocation_Ljava_lang_Runnable_ = JNIEnv.GetStaticMethodID (class_ref, "setPreInvocation", "(Ljava/lang/Runnable;)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setPreInvocation_Ljava_lang_Runnable_, __args);
			} finally {
			}
		}
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setPreShowingSurveyRunnable' and count(parameter)=1 and parameter[1][@type='java.lang.Runnable']]"
		[Register ("setPreShowingSurveyRunnable", "(Ljava/lang/Runnable;)V", "")]
		public static unsafe void SetPreShowingSurveyRunnable (global::Java.Lang.IRunnable p0)
		{
		...
		static IntPtr id_setPromptOptionsEnabled_ZZZ;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setPromptOptionsEnabled' and count(parameter)=3 and parameter[1][@type='boolean'] and parameter[2][@type='boolean'] and parameter[3][@type='boolean']]"
		[Register ("setPromptOptionsEnabled", "(ZZZ)V", "")]
		public static unsafe void SetPromptOptionsEnabled (bool p0, bool p1, bool p2)
		{
			if (id_setPromptOptionsEnabled_ZZZ == IntPtr.Zero)
				id_setPromptOptionsEnabled_ZZZ = JNIEnv.GetStaticMethodID (class_ref, "setPromptOptionsEnabled", "(ZZZ)V");
			try {
				JValue* __args = stackalloc JValue [3];
				__args [0] = new JValue (p0);
				__args [1] = new JValue (p1);
				__args [2] = new JValue (p2);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setPromptOptionsEnabled_ZZZ, __args);
			} finally {
			}
		}
		...
		static IntPtr id_setShakingThreshold_I;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setShakingThreshold' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("setShakingThreshold", "(I)V", "")]
		public static unsafe void SetShakingThreshold (int p0)
		{
			if (id_setShakingThreshold_I == IntPtr.Zero)
				id_setShakingThreshold_I = JNIEnv.GetStaticMethodID (class_ref, "setShakingThreshold", "(I)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setShakingThreshold_I, __args);
			} finally {
			}
		}
		...
		static IntPtr id_setShouldPlayConversationSounds_Z;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setShouldPlayConversationSounds' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("setShouldPlayConversationSounds", "(Z)V", "")]
		public static unsafe void SetShouldPlayConversationSounds (bool p0)
		{
			if (id_setShouldPlayConversationSounds_Z == IntPtr.Zero)
				id_setShouldPlayConversationSounds_Z = JNIEnv.GetStaticMethodID (class_ref, "setShouldPlayConversationSounds", "(Z)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setShouldPlayConversationSounds_Z, __args);
			} finally {
			}
		}

		static IntPtr id_setSuccessDialogEnabled_Z;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setSuccessDialogEnabled' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("setSuccessDialogEnabled", "(Z)V", "")]
		public static unsafe void SetSuccessDialogEnabled (bool p0)
		{
			if (id_setSuccessDialogEnabled_Z == IntPtr.Zero)
				id_setSuccessDialogEnabled_Z = JNIEnv.GetStaticMethodID (class_ref, "setSuccessDialogEnabled", "(Z)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setSuccessDialogEnabled_Z, __args);
			} finally {
			}
		}
		...
		static IntPtr id_setVideoRecordingFloatingButtonCorner_Lcom_instabug_library_invocation_util_InstabugVideoRecordingButtonCorner_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setVideoRecordingFloatingButtonCorner' and count(parameter)=1 and parameter[1][@type='com.instabug.library.invocation.util.InstabugVideoRecordingButtonCorner']]"
		[Register ("setVideoRecordingFloatingButtonCorner", "(Lcom/instabug/library/invocation/util/InstabugVideoRecordingButtonCorner;)V", "")]
		public static unsafe void SetVideoRecordingFloatingButtonCorner (global::Com.Instabug.Library.Invocation.Util.InstabugVideoRecordingButtonCorner p0)
		{
			if (id_setVideoRecordingFloatingButtonCorner_Lcom_instabug_library_invocation_util_InstabugVideoRecordingButtonCorner_ == IntPtr.Zero)
				id_setVideoRecordingFloatingButtonCorner_Lcom_instabug_library_invocation_util_InstabugVideoRecordingButtonCorner_ = JNIEnv.GetStaticMethodID (class_ref, "setVideoRecordingFloatingButtonCorner", "(Lcom/instabug/library/invocation/util/InstabugVideoRecordingButtonCorner;)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setVideoRecordingFloatingButtonCorner_Lcom_instabug_library_invocation_util_InstabugVideoRecordingButtonCorner_, __args);
			} finally {
			}
		}

		static IntPtr id_setWillSkipScreenshotAnnotation_Z;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='setWillSkipScreenshotAnnotation' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("setWillSkipScreenshotAnnotation", "(Z)V", "")]
		public static unsafe void SetWillSkipScreenshotAnnotation (bool p0)
		{
			if (id_setWillSkipScreenshotAnnotation_Z == IntPtr.Zero)
				id_setWillSkipScreenshotAnnotation_Z = JNIEnv.GetStaticMethodID (class_ref, "setWillSkipScreenshotAnnotation", "(Z)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setWillSkipScreenshotAnnotation_Z, __args);
			} finally {
			}
		}
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='Instabug']/method[@name='showValidSurvey' and count(parameter)=0]"
