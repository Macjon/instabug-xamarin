	...
	public partial class BitIO : global::Java.Lang.Object {
		...
		public partial interface IInputBits : IJavaObject {
			...
			int Bit {
				...
				[Register ("getBit", "()I", "GetGetBitHandler:Org.Jcodec.Codecs.Common.Biari.BitIO/IInputBitsInvoker, InstabugAndroidCoreSDK")] get;
			}
...
#pragma warning restore 0169
		...
		public partial interface IOutputBits : IJavaObject {
			...
			[Register ("flush", "()V", "GetFlushHandler:Org.Jcodec.Codecs.Common.Biari.BitIO/IOutputBitsInvoker, InstabugAndroidCoreSDK")]
			void Flush ();
			...
			[Register ("putBit", "(I)V", "GetPutBit_IHandler:Org.Jcodec.Codecs.Common.Biari.BitIO/IOutputBitsInvoker, InstabugAndroidCoreSDK")]
			void PutBit (int p0);
...
#pragma warning restore 0169
		...
		public partial class StreamInputBits : global::Java.Lang.Object, global::Org.Jcodec.Codecs.Common.Biari.BitIO.IInputBits {
			...
			public unsafe StreamInputBits (global::System.IO.Stream @in)
...
#pragma warning restore 0169
		...
		public partial class StreamOutputBits : global::Java.Lang.Object, global::Org.Jcodec.Codecs.Common.Biari.BitIO.IOutputBits {
			...
			public unsafe StreamOutputBits (global::System.IO.Stream @out)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
					return;
...
#pragma warning disable 0169
			...
			static void n_PutBit_I (IntPtr jnienv, IntPtr native__this, int symbol)
			{
				global::Org.Jcodec.Codecs.Common.Biari.BitIO.StreamOutputBits __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Codecs.Common.Biari.BitIO.StreamOutputBits> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				__this.PutBit (symbol);
			}
#pragma warning restore 0169
			...
			public virtual unsafe void PutBit (int symbol)
			{
				if (id_putBit_I == IntPtr.Zero)
					id_putBit_I = JNIEnv.GetMethodID (class_ref, "putBit", "(I)V");
				try {
		...
		public static unsafe byte[] CompressBits (int[] decompressed)
		{
			if (id_compressBits_arrayI == IntPtr.Zero)
				id_compressBits_arrayI = JNIEnv.GetStaticMethodID (class_ref, "compressBits", "([I)[B");
			IntPtr native_decompressed = JNIEnv.NewArray (decompressed);
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (native_decompressed);
				...
				if (decompressed != null) {
					JNIEnv.CopyArray (native_decompressed, decompressed);
					JNIEnv.DeleteLocalRef (native_decompressed);
				}
			}
		}
		...
		public static unsafe int[] DecompressBits (byte[] compressed)
		{
			if (id_decompressBits_arrayB == IntPtr.Zero)
				id_decompressBits_arrayB = JNIEnv.GetStaticMethodID (class_ref, "decompressBits", "([B)[I");
			IntPtr native_compressed = JNIEnv.NewArray (compressed);
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (native_compressed);
				...
				if (compressed != null) {
					JNIEnv.CopyArray (native_compressed, compressed);
					JNIEnv.DeleteLocalRef (native_compressed);
				}
			}
		}
		...
		public static unsafe global::Org.Jcodec.Codecs.Common.Biari.BitIO.IInputBits InputFromArray (byte[] bytes)
		{
		...
		public static unsafe global::Org.Jcodec.Codecs.Common.Biari.BitIO.IInputBits InputFromStream (global::System.IO.Stream @is)
		{
		...
		public static unsafe global::Org.Jcodec.Codecs.Common.Biari.BitIO.IOutputBits OutputFromArray (byte[] bytes)
		{
		...
		public static unsafe global::Org.Jcodec.Codecs.Common.Biari.BitIO.IOutputBits OutputFromStream (global::System.IO.Stream @out)
		{
