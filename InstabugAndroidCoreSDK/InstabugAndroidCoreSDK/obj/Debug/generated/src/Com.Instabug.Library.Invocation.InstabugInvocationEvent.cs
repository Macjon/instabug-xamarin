...
namespace Com.Instabug.Library.Invocation {
	...
	public sealed partial class InstabugInvocationEvent : global::Java.Lang.Enum {
		...
		static IntPtr TWO_FINGER_SWIPE_LEFT_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.instabug.library.invocation']/class[@name='InstabugInvocationEvent']/field[@name='TWO_FINGER_SWIPE_LEFT']"
		[Register ("TWO_FINGER_SWIPE_LEFT")]
		public static global::Com.Instabug.Library.Invocation.InstabugInvocationEvent TwoFingerSwipeLeft {
			get {
				if (TWO_FINGER_SWIPE_LEFT_jfieldId == IntPtr.Zero)
					TWO_FINGER_SWIPE_LEFT_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "TWO_FINGER_SWIPE_LEFT", "Lcom/instabug/library/invocation/InstabugInvocationEvent;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, TWO_FINGER_SWIPE_LEFT_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Com.Instabug.Library.Invocation.InstabugInvocationEvent> (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}
