...
namespace Org.Jcodec.Codecs.Mpeg12 {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.jcodec.codecs.mpeg12']/class[@name='MPEGPredOct']"
	[global::Android.Runtime.Register ("org/jcodec/codecs/mpeg12/MPEGPredOct", DoNotGenerateAcw=true)]
	public partial class MPEGPredOct : global::Org.Jcodec.Codecs.Mpeg12.MPEGPred {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/jcodec/codecs/mpeg12/MPEGPredOct", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MPEGPredOct); }
		}

		protected MPEGPredOct (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lorg_jcodec_codecs_mpeg12_MPEGPred_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.jcodec.codecs.mpeg12']/class[@name='MPEGPredOct']/constructor[@name='MPEGPredOct' and count(parameter)=1 and parameter[1][@type='org.jcodec.codecs.mpeg12.MPEGPred']]"
		[Register (".ctor", "(Lorg/jcodec/codecs/mpeg12/MPEGPred;)V", "")]
		public unsafe MPEGPredOct (global::Org.Jcodec.Codecs.Mpeg12.MPEGPred other)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (MPEGPredOct)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Org.Jcodec.Codecs.Mpeg12.MPEGPredOct __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Codecs.Mpeg12.MPEGPredOct> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jcodec.codecs.mpeg12']/class[@name='MPEGPredOct']/method[@name='getPix2' and count(parameter)=10 and parameter[1][@type='int[]'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int'] and parameter[5][@type='int'] and parameter[6][@type='int'] and parameter[7][@type='int'] and parameter[8][@type='int'] and parameter[9][@type='int'] and parameter[10][@type='int']]"
