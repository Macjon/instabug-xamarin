...
namespace Org.Jcodec.Containers.Mps.Psi {
	...
	public partial class PSISection : global::Java.Lang.Object {
		...
		public unsafe PSISection (int tableId, int specificId, int versionNumber, int currentNextIndicator, int sectionNumber, int lastSectionNumber)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [0] = new JValue (tableId);
				__args [1] = new JValue (specificId);
				__args [2] = new JValue (versionNumber);
				__args [3] = new JValue (currentNextIndicator);
				__args [4] = new JValue (sectionNumber);
				__args [5] = new JValue (lastSectionNumber);
				if (((object) this).GetType () != typeof (PSISection)) {
					SetHandle (
		...
		public unsafe PSISection (global::Org.Jcodec.Containers.Mps.Psi.PSISection other)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				if (((object) this).GetType () != typeof (PSISection)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Lorg/jcodec/containers/mps/psi/PSISection;)V", __args),
							JniHandleOwnership.TransferLocalRef);
...
#pragma warning restore 0169
		...
		public static unsafe global::Org.Jcodec.Containers.Mps.Psi.PSISection Parse (global::Java.Nio.ByteBuffer data)
		{
