...
namespace Org.Jcodec.Scale {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.jcodec.scale']/class[@name='Yuv422pToYuv420p']"
	[global::Android.Runtime.Register ("org/jcodec/scale/Yuv422pToYuv420p", DoNotGenerateAcw=true)]
	public partial class Yuv422pToYuv420p : global::Java.Lang.Object, global::Org.Jcodec.Scale.ITransform {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/jcodec/scale/Yuv422pToYuv420p", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (Yuv422pToYuv420p); }
		}

		protected Yuv422pToYuv420p (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_II;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.jcodec.scale']/class[@name='Yuv422pToYuv420p']/constructor[@name='Yuv422pToYuv420p' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		[Register (".ctor", "(II)V", "")]
		public unsafe Yuv422pToYuv420p (int shiftUp, int shiftDown)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (Yuv422pToYuv420p)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Org.Jcodec.Scale.Yuv422pToYuv420p __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Scale.Yuv422pToYuv420p> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jcodec.scale']/class[@name='Yuv422pToYuv420p']/method[@name='transform' and count(parameter)=2 and parameter[1][@type='org.jcodec.common.model.Picture'] and parameter[2][@type='org.jcodec.common.model.Picture']]"
