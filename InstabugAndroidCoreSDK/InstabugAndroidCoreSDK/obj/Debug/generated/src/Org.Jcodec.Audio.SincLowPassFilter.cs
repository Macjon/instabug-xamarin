...
namespace Org.Jcodec.Audio {
	...
	public partial class SincLowPassFilter : global::Org.Jcodec.Audio.ConvolutionFilter {
		...
		[Register (".ctor", "(D)V", "")]
		public unsafe SincLowPassFilter (double cutoffFreq)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [0] = new JValue (cutoffFreq);
		...
		[Register (".ctor", "(ID)V", "")]
		public unsafe SincLowPassFilter (int kernelSize, double cutoffFreq)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				__args [0] = new JValue (kernelSize);
				__args [1] = new JValue (cutoffFreq);
				if (((object) this).GetType () != typeof (SincLowPassFilter)) {
					SetHandle (
		...
		[Register (".ctor", "(II)V", "")]
		public unsafe SincLowPassFilter (int cutoffFreq, int samplingRate)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
			...
			try {
				JValue* __args = stackalloc JValue [2];
				__args [0] = new JValue (cutoffFreq);
				__args [1] = new JValue (samplingRate);
				if (((object) this).GetType () != typeof (SincLowPassFilter)) {
					SetHandle (
