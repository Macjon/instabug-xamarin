...
namespace Org.Jcodec.Codecs.Common.Biari {
	...
	public partial class MEncoder : global::Java.Lang.Object {
		...
		public unsafe MEncoder (global::Java.Nio.ByteBuffer @out, int[][] models)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;

			IntPtr native_models = JNIEnv.NewArray (models);
			try {
				JValue* __args = stackalloc JValue [2];
				__args [0] = new JValue (@out);
				__args [1] = new JValue (native_models);
				if (((object) this).GetType () != typeof (MEncoder)) {
					SetHandle (
				...
				if (models != null) {
					JNIEnv.CopyArray (native_models, models);
					JNIEnv.DeleteLocalRef (native_models);
				}
			}
		}
...
#pragma warning disable 0169
		...
		static void n_EncodeBin_II (IntPtr jnienv, IntPtr native__this, int model, int bin)
		{
...
#pragma warning restore 0169
		...
		public virtual unsafe void EncodeBin (int model, int bin)
		{
			if (id_encodeBin_II == IntPtr.Zero)
				id_encodeBin_II = JNIEnv.GetMethodID (class_ref, "encodeBin", "(II)V");
			try {
				JValue* __args = stackalloc JValue [2];
				__args [0] = new JValue (model);
				__args [1] = new JValue (bin);
...
#pragma warning disable 0169
		...
		static void n_EncodeBinBypass_I (IntPtr jnienv, IntPtr native__this, int bin)
		{
			global::Org.Jcodec.Codecs.Common.Biari.MEncoder __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Codecs.Common.Biari.MEncoder> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.EncodeBinBypass (bin);
		}
#pragma warning restore 0169
...
#pragma warning disable 0169
		...
		static void n_EncodeBinFinal_I (IntPtr jnienv, IntPtr native__this, int bin)
		{
			global::Org.Jcodec.Codecs.Common.Biari.MEncoder __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Codecs.Common.Biari.MEncoder> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.EncodeBinFinal (bin);
		}
#pragma warning restore 0169
		...
		public virtual unsafe void EncodeBinFinal (int bin)
		{
