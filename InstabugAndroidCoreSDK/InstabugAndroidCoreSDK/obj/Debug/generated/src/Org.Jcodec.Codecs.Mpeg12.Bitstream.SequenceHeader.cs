...
namespace Org.Jcodec.Codecs.Mpeg12.Bitstream {
	...
	public partial class SequenceHeader : global::Java.Lang.Object, global::Org.Jcodec.Codecs.Mpeg12.Bitstream.IMPEGHeader {
		...
		public unsafe SequenceHeader (int horizontal_size, int vertical_size, int aspect_ratio_information, int frame_rate_code, int bit_rate, int vbv_buffer_size_value, int constrained_parameters_flag, int[] intra_quantiser_matrix, int[] non_intra_quantiser_matrix)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;

			IntPtr native_intra_quantiser_matrix = JNIEnv.NewArray (intra_quantiser_matrix);
			IntPtr native_non_intra_quantiser_matrix = JNIEnv.NewArray (non_intra_quantiser_matrix);
			try {
				JValue* __args = stackalloc JValue [9];
				__args [0] = new JValue (horizontal_size);
				__args [1] = new JValue (vertical_size);
				__args [2] = new JValue (aspect_ratio_information);
				__args [3] = new JValue (frame_rate_code);
				__args [4] = new JValue (bit_rate);
				__args [5] = new JValue (vbv_buffer_size_value);
				__args [6] = new JValue (constrained_parameters_flag);
				__args [7] = new JValue (native_intra_quantiser_matrix);
				__args [8] = new JValue (native_non_intra_quantiser_matrix);
				...
				if (intra_quantiser_matrix != null) {
					JNIEnv.CopyArray (native_intra_quantiser_matrix, intra_quantiser_matrix);
					JNIEnv.DeleteLocalRef (native_intra_quantiser_matrix);
				}
				if (non_intra_quantiser_matrix != null) {
					JNIEnv.CopyArray (native_non_intra_quantiser_matrix, non_intra_quantiser_matrix);
					JNIEnv.DeleteLocalRef (native_non_intra_quantiser_matrix);
				}
			}
		}
...
#pragma warning disable 0169
		...
		static void n_CopyExtensions_Lorg_jcodec_codecs_mpeg12_bitstream_SequenceHeader_ (IntPtr jnienv, IntPtr native__this, IntPtr native_sh)
		{
			global::Org.Jcodec.Codecs.Mpeg12.Bitstream.SequenceHeader __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Codecs.Mpeg12.Bitstream.SequenceHeader> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe void CopyExtensions (global::Org.Jcodec.Codecs.Mpeg12.Bitstream.SequenceHeader sh)
		{
		...
		public static unsafe global::Org.Jcodec.Codecs.Mpeg12.Bitstream.SequenceHeader Read (global::Java.Nio.ByteBuffer bb)
		{
		...
		public static unsafe void ReadExtension (global::Java.Nio.ByteBuffer bb, global::Org.Jcodec.Codecs.Mpeg12.Bitstream.SequenceHeader sh)
		{
