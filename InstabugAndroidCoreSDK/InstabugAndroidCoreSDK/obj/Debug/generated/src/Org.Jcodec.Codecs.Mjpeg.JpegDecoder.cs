...
namespace Org.Jcodec.Codecs.Mjpeg {
	...
	public partial class JpegDecoder : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (JpegDecoder)) {
					SetHandle (
		...
		[Register (".ctor", "(ZZ)V", "")]
		public unsafe JpegDecoder (bool interlace, bool topFieldFirst)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		static IntPtr n_DecodeField_Ljava_nio_ByteBuffer_arrayarrayIII (IntPtr jnienv, IntPtr native__this, IntPtr native_data, IntPtr native_data2, int field, int step)
		{
			...
			int[][] data2 = (int[][]) JNIEnv.GetArray (native_data2, JniHandleOwnership.DoNotTransfer, typeof (int[]));
			IntPtr __ret = JNIEnv.ToLocalJniHandle (__this.DecodeField (data, data2, field, step));
			if (data2 != null)
				JNIEnv.CopyArray (data2, native_data2);
			return __ret;
		}
#pragma warning restore 0169
		...
		public virtual unsafe global::Org.Jcodec.Common.Model.Picture DecodeField (global::Java.Nio.ByteBuffer data, int[][] data2, int field, int step)
		{
			...
			try {
				...
				__args [1] = new JValue (native_data2);
				__args [2] = new JValue (field);
				__args [3] = new JValue (step);
...
#pragma warning disable 0169
		...
		static IntPtr n_DecodeFrame_Ljava_nio_ByteBuffer_arrayarrayI (IntPtr jnienv, IntPtr native__this, IntPtr native_data, IntPtr native_data2)
		{
			global::Org.Jcodec.Codecs.Mjpeg.JpegDecoder __this = global::Java.Lang.Object.GetObject<global::Org.Jcodec.Codecs.Mjpeg.JpegDecoder> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Java.Nio.ByteBuffer data = global::Java.Lang.Object.GetObject<global::Java.Nio.ByteBuffer> (native_data, JniHandleOwnership.DoNotTransfer);
			int[][] data2 = (int[][]) JNIEnv.GetArray (native_data2, JniHandleOwnership.DoNotTransfer, typeof (int[]));
			IntPtr __ret = JNIEnv.ToLocalJniHandle (__this.DecodeFrame (data, data2));
			if (data2 != null)
				JNIEnv.CopyArray (data2, native_data2);
			return __ret;
		}
#pragma warning restore 0169
		...
		public virtual unsafe global::Org.Jcodec.Common.Model.Picture DecodeFrame (global::Java.Nio.ByteBuffer data, int[][] data2)
		{
...
#pragma warning restore 0169
		...
		public static unsafe int ToValue (int raw, int length)
		{
