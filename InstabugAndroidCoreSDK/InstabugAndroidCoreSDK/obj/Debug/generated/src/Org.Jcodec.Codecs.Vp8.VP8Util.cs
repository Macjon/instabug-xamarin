...
namespace Org.Jcodec.Codecs.Vp8 {
	...
	public partial class VP8Util : global::Java.Lang.Object {
		...
		public sealed partial class PLANE : global::Java.Lang.Enum {
			...
			public static unsafe global::Org.Jcodec.Codecs.Vp8.VP8Util.PLANE ValueOf (string name)
			{
		...
		public partial class QuantizationParams : global::Java.Lang.Object {
			...
			public unsafe QuantizationParams (int baseIndex, int ydcIndexDelta, int y2dcIndexDelta, int y2acIndexDelta, int chromaDCIndexDelta, int chromaACIndexDelta)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					__args [0] = new JValue (baseIndex);
					__args [1] = new JValue (ydcIndexDelta);
					__args [2] = new JValue (y2dcIndexDelta);
					__args [3] = new JValue (y2acIndexDelta);
					__args [4] = new JValue (chromaDCIndexDelta);
					__args [5] = new JValue (chromaACIndexDelta);
					if (((object) this).GetType () != typeof (QuantizationParams)) {
						SetHandle (
								global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(IIIIII)V", __args),
			...
			public static unsafe int Clip255 (int val)
			{
		...
		public partial class SubblockConstants : global::Java.Lang.Object {
				...
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					if (((object) this).GetType () != typeof (SubblockConstants)) {
						SetHandle (
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (VP8Util)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "()V"),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "()V");
		...
		[Register ("avg2", "(II)I", "")]
		public static unsafe int Avg2 (int x, int y)
		{
		...
		[Register ("avg3", "(III)I", "")]
		public static unsafe int Avg3 (int x, int y, int z)
		{
		...
		public static unsafe int Delta (global::Org.Jcodec.Codecs.Vp8.BooleanArithmeticDecoder bc)
		{
		...
		public static unsafe int[] PickDefaultPrediction (int intra_bmode)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (intra_bmode);
		...
		public static unsafe int PlaneToType (global::Org.Jcodec.Codecs.Vp8.VP8Util.PLANE plane, global::Java.Lang.Boolean withY2)
		{
		...
		public static unsafe int[] PredictDC (int[] above, int[] left)
		{
			if (id_predictDC_arrayIarrayI == IntPtr.Zero)
				id_predictDC_arrayIarrayI = JNIEnv.GetStaticMethodID (class_ref, "predictDC", "([I[I)[I");
			IntPtr native_above = JNIEnv.NewArray (above);
			IntPtr native_left = JNIEnv.NewArray (left);
			try {
				JValue* __args = stackalloc JValue [2];
				__args [0] = new JValue (native_above);
				__args [1] = new JValue (native_left);
				...
				if (above != null) {
					JNIEnv.CopyArray (native_above, above);
					JNIEnv.DeleteLocalRef (native_above);
				}
				if (left != null) {
					JNIEnv.CopyArray (native_left, left);
		...
		public static unsafe int[] PredictHD (int[] above, int[] left, int aboveLeft)
		{
		...
		public static unsafe int[] PredictHE (int[] left, int aboveLeft)
		{
		...
		public static unsafe int[] PredictHU (int[] left)
		{
		...
		public static unsafe int[] PredictLD (int[] above, int[] aboveRight)
		{
			if (id_predictLD_arrayIarrayI == IntPtr.Zero)
				id_predictLD_arrayIarrayI = JNIEnv.GetStaticMethodID (class_ref, "predictLD", "([I[I)[I");
			IntPtr native_above = JNIEnv.NewArray (above);
			IntPtr native_aboveRight = JNIEnv.NewArray (aboveRight);
			try {
				JValue* __args = stackalloc JValue [2];
				__args [0] = new JValue (native_above);
				__args [1] = new JValue (native_aboveRight);
				...
				if (aboveRight != null) {
					JNIEnv.CopyArray (native_aboveRight, aboveRight);
					JNIEnv.DeleteLocalRef (native_aboveRight);
				}
			}
		}
		...
		public static unsafe int[] PredictRD (int[] above, int[] left, int aboveLeft)
		{
		...
		public static unsafe int[] PredictTM (int[] above, int[] left, int aboveLeft)
		{
		...
		public static unsafe int[] PredictVE (int[] above, int aboveLeft, int[] aboveRight)
		{
			...
			try {
				...
				__args [0] = new JValue (native_above);
				__args [1] = new JValue (aboveLeft);
				__args [2] = new JValue (native_aboveRight);
		...
		public static unsafe int[] PredictVL (int[] above, int[] aboveRight)
		{
		...
		public static unsafe int[] PredictVR (int[] above, int[] left, int aboveLeft)
		{
