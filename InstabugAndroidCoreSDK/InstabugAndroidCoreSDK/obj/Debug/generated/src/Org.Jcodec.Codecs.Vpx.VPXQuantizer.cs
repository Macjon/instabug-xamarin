...
namespace Org.Jcodec.Codecs.Vpx {
	...
	public partial class VPXQuantizer : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (VPXQuantizer)) {
					SetHandle (
		...
		public unsafe void DequantizeUV (int[] coeffs, int qp)
		{
		...
		public unsafe void DequantizeY (int[] coeffs, int qp)
		{
		...
		public unsafe void DequantizeY2 (int[] coeffs, int qp)
		{
		...
		public unsafe void QuantizeUV (int[] coeffs, int qp)
		{
		...
		public unsafe void QuantizeY (int[] coeffs, int qp)
		{
		...
		public unsafe void QuantizeY2 (int[] coeffs, int qp)
		{
