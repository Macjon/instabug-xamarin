	...
	public partial class MTSTrackFactory : global::Java.Lang.Object {
		...
		public partial class MTSProgram : global::Org.Jcodec.Movtool.Streaming.Tracks.MPSTrackFactory {
			...
			public partial class MTSStream : global::Org.Jcodec.Movtool.Streaming.Tracks.MPSTrackFactory.Stream {
				...
				public unsafe MTSStream (global::Org.Jcodec.Movtool.Streaming.Tracks.MTSTrackFactory.MTSProgram __self, int p1)
			...
			public unsafe MTSProgram (global::Org.Jcodec.Movtool.Streaming.Tracks.MTSTrackFactory __self, global::Java.Nio.ByteBuffer p1, global::Org.Jcodec.Movtool.Streaming.Tracks.FilePool p2)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
					return;
				...
				try {
					...
					if (GetType () != typeof (MTSProgram)) {
						SetHandle (
								global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(L" + global::Android.Runtime.JNIEnv.GetJniName (GetType ().DeclaringType) + ";Ljava/nio/ByteBuffer;Lorg/jcodec/movtool/streaming/tracks/FilePool;)V", __args),
								JniHandleOwnership.TransferLocalRef);
		...
		public unsafe MTSTrackFactory (global::Java.Nio.ByteBuffer p0, global::Org.Jcodec.Movtool.Streaming.Tracks.FilePool p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				__args [1] = new JValue (p1);
				if (GetType () != typeof (MTSTrackFactory)) {
					SetHandle (
