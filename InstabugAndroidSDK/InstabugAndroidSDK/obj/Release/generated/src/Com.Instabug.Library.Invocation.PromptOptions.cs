...
namespace Com.Instabug.Library.Invocation {
	...
	public partial class PromptOptions : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (PromptOptions)) {
					SetHandle (
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (PromptOptions)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(ZZZ)V", __args),
							JniHandleOwnership.TransferLocalRef);
