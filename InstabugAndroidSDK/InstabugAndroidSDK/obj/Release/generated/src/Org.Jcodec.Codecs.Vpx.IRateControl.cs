...
namespace Org.Jcodec.Codecs.Vpx {
	...
	public partial interface IRateControl : IJavaObject {
		...
		int Segment {
			...
			[Register ("getSegment", "()I", "GetGetSegmentHandler:Org.Jcodec.Codecs.Vpx.IRateControlInvoker, InstabugAndroidSDK")] get;
		}
		...
		[Register ("getSegmentQps", "()[I", "GetGetSegmentQpsHandler:Org.Jcodec.Codecs.Vpx.IRateControlInvoker, InstabugAndroidSDK")]
		int[] GetSegmentQps ();
		...
		[Register ("report", "(I)V", "GetReport_IHandler:Org.Jcodec.Codecs.Vpx.IRateControlInvoker, InstabugAndroidSDK")]
		void Report (int p0);
		...
		[Register ("reset", "()V", "GetResetHandler:Org.Jcodec.Codecs.Vpx.IRateControlInvoker, InstabugAndroidSDK")]
		void Reset ();
