...
namespace Org.Jcodec.Codecs.H264.Encode {
	...
	public partial interface IRateControl : IJavaObject {
		...
		int InitQp {
			...
			[Register ("getInitQp", "()I", "GetGetInitQpHandler:Org.Jcodec.Codecs.H264.Encode.IRateControlInvoker, InstabugAndroidSDK")] get;
		}
		...
		int QpDelta {
			...
			[Register ("getQpDelta", "()I", "GetGetQpDeltaHandler:Org.Jcodec.Codecs.H264.Encode.IRateControlInvoker, InstabugAndroidSDK")] get;
		}
		...
		[Register ("accept", "(I)Z", "GetAccept_IHandler:Org.Jcodec.Codecs.H264.Encode.IRateControlInvoker, InstabugAndroidSDK")]
		bool Accept (int p0);
		...
		[Register ("reset", "()V", "GetResetHandler:Org.Jcodec.Codecs.H264.Encode.IRateControlInvoker, InstabugAndroidSDK")]
		void Reset ();
