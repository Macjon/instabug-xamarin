...
namespace Com.Instabug.Library.Invocation {
	...
	public partial class InvocationSettings : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (InvocationSettings)) {
					SetHandle (
...
#pragma warning disable 0169
		static Delegate GetSetFloatingButtonEdge_Lcom_instabug_library_invocation_util_InstabugFloatingButtonEdge_Handler ()
		{
			if (cb_setFloatingButtonEdge_Lcom_instabug_library_invocation_util_InstabugFloatingButtonEdge_ == null)
				cb_setFloatingButtonEdge_Lcom_instabug_library_invocation_util_InstabugFloatingButtonEdge_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_SetFloatingButtonEdge_Lcom_instabug_library_invocation_util_InstabugFloatingButtonEdge_);
			return cb_setFloatingButtonEdge_Lcom_instabug_library_invocation_util_InstabugFloatingButtonEdge_;
		}

		static void n_SetFloatingButtonEdge_Lcom_instabug_library_invocation_util_InstabugFloatingButtonEdge_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			...
			__this.SetFloatingButtonEdge (p0);
		}
#pragma warning restore 0169

		static IntPtr id_setFloatingButtonEdge_Lcom_instabug_library_invocation_util_InstabugFloatingButtonEdge_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library.invocation']/class[@name='InvocationSettings']/method[@name='setFloatingButtonEdge' and count(parameter)=1 and parameter[1][@type='com.instabug.library.invocation.util.InstabugFloatingButtonEdge']]"
		[Register ("setFloatingButtonEdge", "(Lcom/instabug/library/invocation/util/InstabugFloatingButtonEdge;)V", "GetSetFloatingButtonEdge_Lcom_instabug_library_invocation_util_InstabugFloatingButtonEdge_Handler")]
		public virtual unsafe void SetFloatingButtonEdge (global::Com.Instabug.Library.Invocation.Util.InstabugFloatingButtonEdge p0)
		{
			if (id_setFloatingButtonEdge_Lcom_instabug_library_invocation_util_InstabugFloatingButtonEdge_ == IntPtr.Zero)
				id_setFloatingButtonEdge_Lcom_instabug_library_invocation_util_InstabugFloatingButtonEdge_ = JNIEnv.GetMethodID (class_ref, "setFloatingButtonEdge", "(Lcom/instabug/library/invocation/util/InstabugFloatingButtonEdge;)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);

				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setFloatingButtonEdge_Lcom_instabug_library_invocation_util_InstabugFloatingButtonEdge_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setFloatingButtonEdge", "(Lcom/instabug/library/invocation/util/InstabugFloatingButtonEdge;)V"), __args);
			} finally {
			}
		}
