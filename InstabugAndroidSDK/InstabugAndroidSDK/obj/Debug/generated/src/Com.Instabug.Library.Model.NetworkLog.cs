...
namespace Com.Instabug.Library.Model {
	...
	public partial class NetworkLog : global::Java.Lang.Object {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.instabug.library.model']/class[@name='NetworkLog']/field[@name='CONTENT_TYPE']"
		[Register ("CONTENT_TYPE")]
		public const string ContentType = (string) "content-type";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.instabug.library.model']/class[@name='NetworkLog']/field[@name='HTML']"
		[Register ("HTML")]
		public const string Html = (string) "text/html";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.instabug.library.model']/class[@name='NetworkLog']/field[@name='JSON']"
		[Register ("JSON")]
		public const string Json = (string) "application/json";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.instabug.library.model']/class[@name='NetworkLog']/field[@name='LIMIT_ERROR']"
		[Register ("LIMIT_ERROR")]
		public const string LimitError = (string) "{\"InstabugNetworkLog Error\":\"Response body exceeded limit\"}";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.instabug.library.model']/class[@name='NetworkLog']/field[@name='PLAIN_TEXT']"
		[Register ("PLAIN_TEXT")]
		public const string PlainText = (string) "text/plain";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.instabug.library.model']/class[@name='NetworkLog']/field[@name='XML_1']"
		[Register ("XML_1")]
		public const string Xml1 = (string) "application/xml";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.instabug.library.model']/class[@name='NetworkLog']/field[@name='XML_2']"
		[Register ("XML_2")]
		public const string Xml2 = (string) "text/xml";
...
#pragma warning restore 0169
		...
		static Delegate cb_insert;
#pragma warning disable 0169
		static Delegate GetInsertHandler ()
		{
			if (cb_insert == null)
				cb_insert = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, long>) n_Insert);
			return cb_insert;
		}

		static long n_Insert (IntPtr jnienv, IntPtr native__this)
		{
			global::Com.Instabug.Library.Model.NetworkLog __this = global::Java.Lang.Object.GetObject<global::Com.Instabug.Library.Model.NetworkLog> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.Insert ();
		}
#pragma warning restore 0169

		static IntPtr id_insert;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library.model']/class[@name='NetworkLog']/method[@name='insert' and count(parameter)=0]"
		[Register ("insert", "()J", "GetInsertHandler")]
		public virtual unsafe long Insert ()
		{
			if (id_insert == IntPtr.Zero)
				id_insert = JNIEnv.GetMethodID (class_ref, "insert", "()J");
			try {

				if (((object) this).GetType () == ThresholdType)
					return JNIEnv.CallLongMethod (((global::Java.Lang.Object) this).Handle, id_insert);
				else
					return JNIEnv.CallNonvirtualLongMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "insert", "()J"));
			} finally {
			}
		}
