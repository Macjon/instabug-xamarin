...
namespace Org.Jcodec.Audio {
	...
	public partial interface IAudioFilter : IJavaObject {
		...
		int Delay {
			...
			[Register ("getDelay", "()I", "GetGetDelayHandler:Org.Jcodec.Audio.IAudioFilterInvoker, InstabugAndroidSDK")] get;
		}
		...
		int NInputs {
			...
			[Register ("getNInputs", "()I", "GetGetNInputsHandler:Org.Jcodec.Audio.IAudioFilterInvoker, InstabugAndroidSDK")] get;
		}
		...
		int NOutputs {
			...
			[Register ("getNOutputs", "()I", "GetGetNOutputsHandler:Org.Jcodec.Audio.IAudioFilterInvoker, InstabugAndroidSDK")] get;
		}
		...
		[Register ("filter", "([Ljava/nio/FloatBuffer;[J[Ljava/nio/FloatBuffer;)V", "GetFilter_arrayLjava_nio_FloatBuffer_arrayJarrayLjava_nio_FloatBuffer_Handler:Org.Jcodec.Audio.IAudioFilterInvoker, InstabugAndroidSDK")]
