...
namespace Com.Instabug.Library {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.instabug.library']/class[@name='InstabugNetworkReceiver']"
	[global::Android.Runtime.Register ("com/instabug/library/InstabugNetworkReceiver", DoNotGenerateAcw=true)]
	public partial class InstabugNetworkReceiver : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/instabug/library/InstabugNetworkReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (InstabugNetworkReceiver); }
		}

		protected InstabugNetworkReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.instabug.library']/class[@name='InstabugNetworkReceiver']/constructor[@name='InstabugNetworkReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe InstabugNetworkReceiver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (InstabugNetworkReceiver)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Instabug.Library.InstabugNetworkReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Instabug.Library.InstabugNetworkReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.instabug.library']/class[@name='InstabugNetworkReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
